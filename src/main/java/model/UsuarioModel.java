...
public class UsuarioModel {
	 ...
	 * @param nombre Atributo de solo texto donde se inserta el nombre del usuario
	 * @param correo Atributo de solo texto donde se inserta el correo del usuario
	...
	/**
	 * Método para modificar la contraseña, en este caso no lo usaremos pero lo dejamos para futuras implementaciones
	...
	/**
	 * Método de inclusion del idUsuario en el objeto, autogenerado por la Base de Datos
	...
	/**
	 * Método para modificar el IDuSUARIO, en este caso no lo usaremos pero lo dejamos para futuras implementaciones
	...
	/**
	 * Constructor para la creacion del objeto desde el formulario
	 * @param idUsuario Atributo int donde se inseratá un id único autogenerado por la base de datos para cada ususario
	 * @param nombre Atributo solo texto donde se insertará el nombre del usuario en el objeto
	 * @param correo Atributo de solo texto donde se insertará el correo en el objeto
	 * @param contrasena Atributo de solo texto donde se insertará la contraseña en le objeto
	 * @param foto Atributo en forma de archivo de imagen qiue se insertará en el objeto usuario
	 * @param permiso Atributo que otrogaremos a un Usuario que definirá si es un Usuiario corrienet o un administrador
	 */
